      ...
      <div className="hero min-h-screen" style={{ backgroundImage: `url("https://i.ibb.co/yytz9ff/Whats-App-Image-2023-01-15-at-23-26-37.jpg")` }}>
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5 font-serif text-justify indent-4 " >Fernando Aponte, an automation engineer with over a year of experience, has a proven track record of designing and implementing innovative automation solutions to improve efficiency and productivity. He has a strong background in programming languages such as Python, and has experience in various automation tools like Selenium, Appium, and Jenkins. With a passion for technology and problem-solving, Fernando is dedicated to driving results and staying ahead of the curve in the rapidly evolving field of automation engineering.</p>
            <Link role="button" href="/portfolio" className="btn btn-info hover:scale-125 hover:shadow-xl hover:font-bold hover:text-white">My Projects</Link>
          </div>
        </div>
      </div>
      </main>
